class Tweet < ActiveRecord::Base
  ...
  def self.get_latest_new_year_resolution_tweets
    ...
    #grab recent 100 tweets which contain 'indie' words, and loop each of them
    search.containing("indie").result_type("recent").per_page(100).fetch.each do |tweet_results|
